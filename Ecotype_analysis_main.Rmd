...
B <- ggplot(allpike_pheno[allpike_pheno$phenotype=="BW-resident",])+
  ...
  theme(legend.position = "none", 
        ...
        plot.background = element_blank())+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "brackish resident (N = 44)", size = 7, just = "left"),
                    ymin = 9.3, ymax = 9.3, xmin = 100, xmax = 100)
...
D <- ggplot(allpike_pheno[allpike_pheno$phenotype=="Trans-habitat",])+
  ...
  theme(legend.position = "none", 
        ...
        plot.background = element_blank())+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "cross-habitat type (N = 28)", size = 7, just = "left"),
                    ymin = 9.3, ymax = 9.3, xmin = 100, xmax = 100)
