...
chisq.test(table(Otogen2$area, Otogen2$hardclust))
...
ggsave("Figures/MS/Phenotype-effects-growth.pdf", Ecogrowth, width = 16, height = 8, dpi = 600, bg = "white")
```
