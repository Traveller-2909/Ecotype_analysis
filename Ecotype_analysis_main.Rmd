...
A <- ggplot(allpike_eco[allpike_eco$ecotype=="FW-resident",])+
  ...
  theme(legend.position = "none", 
        ...
        axis.line = element_line(size = 0.3))+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "freshwater", size = 36, just = "left"),
...
B <- ggplot(allpike_eco[allpike_eco$ecotype=="BW-resident",])+
  ...
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "brackish", size = 36, just = "left"),
                    ymin = 9.5, ymax = 9.5, xmin = -120, xmax = -120)
...
C <- ggplot(allpike_eco[allpike_eco$ecotype=="Anadromous",])+
  ...
  theme(legend.position = "none", 
        ...
        plot.background = element_blank())+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "anadromous", size = 36, just = "left"),
                    ymin = 9.5, ymax = 9.5, xmin = -120, xmax = -120)
...
D <- ggplot(allpike_eco[allpike_eco$ecotype=="Trans-habitat",])+
  ...
  theme(legend.position = "none", 
        ...
        plot.background = element_blank())+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "cross-habitat", size = 36, just = "left"),
                    ymin = 9.5, ymax = 9.5, xmin = -120, xmax = -120)
...
Agegrowth <- ggplot(Newdata2, aes(factor(lifeyear), prediction, fill=ecotype), alpha=0.6)+
  geom_boxplot(lwd=.1, outlier.shape = NA, width=.5, position = position_dodge(width = NULL), color="black")+
...
ggsave("Figures/MS/Ecotype-age-specific-growth.png", Agegrowth, width = 22, height = 10, units = "cm", dpi = 600, bg = "white")

png(filename = "Figures/Ecotype_effects_growth_lifelong.png",width = 3000, height = 1500, res = 600)
dev.off()

ggplot(Newdata2[Newdata$lifeyear<=9,], aes(Sr_mean, prediction, color=as.factor(lifeyear)))+
...
ggsave("Figures/MS/Individual-growth-curves.png", Curves2, width = 22, height = 10, dpi = 600, units = "cm", bg = "white")
```
