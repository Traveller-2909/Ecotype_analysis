...
A <- ggplot(allpike_eco[allpike_eco$ecotype=="FW-resident",])+
  ...
  theme(legend.position = "none", 
        ...
        axis.line = element_line(size = 0.3))+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "Freshwater resident (N = 13)", size = 7),
                    ymin = 10, ymax = 10, xmin = 750, xmax = 750)
...
B <- ggplot(allpike_eco[allpike_eco$ecotype=="BW-resident",])+
  ...
  theme(legend.position = "none", 
        ...
        axis.line = element_line(size = 0.3))+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "Brackish resident (N = 46)", size = 7),
                    ymin = 10, ymax = 10, xmin = 1090, xmax = 1090)
...
C <- ggplot(allpike_eco[allpike_eco$ecotype=="Anadromous",])+
  ...
  theme(legend.position = "none", 
        ...
        axis.line = element_line(size = 0.3))+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "Anadromous type (N = 30)", size = 7),
                    ymin = 10, ymax = 10, xmin = 1090, xmax = 1090)
...
D <- ggplot(allpike_eco[allpike_eco$ecotype=="Trans-habitat",])+
  ...
  theme(legend.position = "none", 
        ...
        axis.line = element_line(size = 0.3))+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "Cross-habitat type (N = 31)", size = 7),
                    ymin = 10, ymax = 10, xmin = 1000, xmax = 1000)
...
png(filename = "Figures/DTW-plots/Allplot_ecotypes.png", width = 4000, height = 2000, res = 600)
plot_grid(allplot[[1]],allplot[[3]],allplot[[4]],allplot[[2]], allplot[[5]], allplot[[7]], allplot[[8]], allplot[[6]], nrow = 2, ncol = 4)
dev.off()
```
