...
A1 <- ggplot(allpike_eco[allpike_eco$ecotype=="FW-resident",])+
  ...
  theme(legend.position = "none", 
        ...
        axis.title.y = element_text(size = 24, margin = margin(r=10), vjust = 3),
        axis.title.x = element_blank(),
        axis.line = element_line(size = 0.3))+
  coord_cartesian(clip = "off")+
    geom_segment(x=-380, y=0, xend=-380, yend=-3.2, 
               lineend = "butt", linejoin = "mitre",
               size=5, arrow = arrow(length = unit(0.18, "inches")),
               color="#FF6666")+
  annotation_custom(grob = text_grob(label = "warmer", 
                                     ...
                                     ymin=0, ymax=-3,
                                     xmin=-390, xmax=-390)+
  geom_segment(x=-380, y=0, xend=-380, yend=3, 
               lineend = "butt", linejoin = "mitre",
               size=5, arrow = arrow(length = unit(0.18, "inches")),
               color="#66CCCC")+
...
B <- ggplot(allpike_eco[allpike_eco$ecotype=="BW-resident",])+
  ...
  annotation_custom(grob = text_grob(label = "brackish", size = 36, just = "left"),
                    ymin = 9.5, ymax = 9.5, xmin = 100, xmax = 100)
...
ggsave("Figures/MS/Ecotypes-life-history-transects_poster.png", Transects2, dpi = 600, width = 45, height = 16, units = "cm", bg = "white")
```
